...
namespace eval emif2 {
  ...
  proc get_design_files {QSYS_SIMDIR QUARTUS_INSTALL_DIR} {
    set design_files [dict create]
    dict set design_files "emif2_altera_emif_arch_fm_191_mkhcfgy_top.sv" "$QSYS_SIMDIR/../altera_emif_arch_fm_191/sim/emif2_altera_emif_arch_fm_191_mkhcfgy_top.sv"
    ...
    dict set design_files "emif2_altera_emif_arch_fm_191_mkhcfgy.sv"     "$QSYS_SIMDIR/../altera_emif_arch_fm_191/sim/emif2_altera_emif_arch_fm_191_mkhcfgy.sv"    
    dict set design_files "emif2_altera_emif_fm_277_f2nlyqq.v"           "$QSYS_SIMDIR/../altera_emif_fm_277/sim/emif2_altera_emif_fm_277_f2nlyqq.v"               
    dict set design_files "emif2.v"                                      "$QSYS_SIMDIR/emif2.v"                                                                    
    return $design_files
  }
