...
namespace eval emif2 {
  ...
  proc get_design_files {QSYS_SIMDIR QUARTUS_INSTALL_DIR} {
    ...
    lappend design_files "-makelib altera_emif_arch_fm_191 \"[normalize_path "$QSYS_SIMDIR/../altera_emif_arch_fm_191/sim/emif2_altera_emif_arch_fm_191_mkhcfgy_top.sv"]\"   -end"
    ...
    lappend design_files "-makelib altera_emif_arch_fm_191 \"[normalize_path "$QSYS_SIMDIR/../altera_emif_arch_fm_191/sim/emif2_altera_emif_arch_fm_191_mkhcfgy.sv"]\"   -end"    
    lappend design_files "-makelib altera_emif_fm_277 \"[normalize_path "$QSYS_SIMDIR/../altera_emif_fm_277/sim/emif2_altera_emif_fm_277_f2nlyqq.v"]\"   -end"                    
    lappend design_files "-makelib emif2 \"[normalize_path "$QSYS_SIMDIR/emif2.v"]\"   -end"                                                                                      
    return $design_files
  }
