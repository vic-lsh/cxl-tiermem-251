...
set cam_clk      [get_clocks *|cxl_memexp_sip_top|gen_clkrst|cxl_memexp_sip_clkgen|rnr_ial_sip_clkgen_pll_cam_clk]
set sbr_clk      [get_clocks *|cxl_memexp_sip_top|gen_clkrst|cxl_memexp_sip_clkgen|rnr_ial_sip_clkgen_pll_sbr_clk]
set emif_usr_clk_0 [get_clocks ed_top_wrapper_typ3_inst|inst_emif_avmm|GEN_CHAN_COUNT_EMIF_REVB[0].NON_HPS_MEM.emif_inst|emif_core_usr_clk]
set emif_usr_clk_1 [get_clocks ed_top_wrapper_typ3_inst|inst_emif_avmm|GEN_CHAN_COUNT_EMIF_REVB[1].HPS_MEM.emif_inst_2|emif_fm_0_core_usr_clk]
