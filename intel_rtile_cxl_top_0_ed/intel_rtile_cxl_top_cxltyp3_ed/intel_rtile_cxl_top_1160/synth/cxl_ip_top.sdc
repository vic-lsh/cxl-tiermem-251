...
set pld_clk      [get_clocks $ip_inst_name|inst_cxl_type3_top|cxl_ip|rtile_cxl_ip.coreclkout_hip]
set side_hip_clk [get_clocks $ip_inst_name|inst_cxl_type3_top|cxl_ip|rtile_cxl_ip.pld_clkout_slow]
set cam_clk      [get_clocks $ip_inst_name|inst_cxl_type3_top|cxl_memexp_sip_top|gen_clkrst|cxl_memexp_sip_clkgen|rnr_ial_sip_clkgen_pll_cam_clk]
set sbr_clk      [get_clocks $ip_inst_name|inst_cxl_type3_top|cxl_memexp_sip_top|gen_clkrst|cxl_memexp_sip_clkgen|rnr_ial_sip_clkgen_pll_sbr_clk]
...
set_false_path -to $ip_inst_name|inst_cxl_type3_top|cxl_memexp_sip_top|gen_clkrst|*_rstn_pipe*|clrn
set_false_path -to $ip_inst_name|inst_cxl_type3_top|cxl_memexp_sip_top|gen_clkrst|*_rstn_pipe[0]|d
