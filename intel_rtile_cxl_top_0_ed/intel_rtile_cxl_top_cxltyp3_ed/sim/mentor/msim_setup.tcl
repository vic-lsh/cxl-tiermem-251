...
# ----------------------------------------
# ACDS 25.1 129 linux 2025.05.05.21:02:56
...
alias file_copy {
  ...
  set memory_files [concat $memory_files [intel_rtile_cxl_top_cxltyp3_ed::get_memory_files "$QSYS_SIMDIR" "$QUARTUS_INSTALL_DIR"]]
...
set libraries [dict merge $libraries [intel_rtile_cxl_top_cxltyp3_ed::get_dpi_libraries "$QSYS_SIMDIR"]]
...
alias com {
  ...
  set common_design_files [dict values [intel_rtile_cxl_top_cxltyp3_ed::get_common_design_files "$QSYS_SIMDIR"]]
  
  set design_files [list]
  set design_files [concat $design_files [intel_rtile_cxl_top_cxltyp3_ed::get_design_files "$QSYS_SIMDIR" "$QUARTUS_INSTALL_DIR"]]
